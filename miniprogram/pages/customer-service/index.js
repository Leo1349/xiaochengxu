  ...
  data: {
    ...
    faqList: [
      ...
      },
      {
        id: 4,
        question: '如何申请退款？',
        answer: '如果服务尚未开始，您可以直接取消订单申请全额退款。如果服务已开始但不满意，请联系客服说明情况，我们会根据实际情况处理退款申请。',
        expanded: false
      },
      {
        id: 5,
        question: '如何成为陪伴师？',
        answer: '在"我的"页面切换到陪伴师模式，完善个人简历并提交审核。审核通过后即可开始接单。您需要年满18周岁，具有相关教育经验或资格证书。',
        expanded: false
      },
      {
        id: 6,
        question: '服务过程中遇到问题怎么办？',
        answer: '您可以随时通过订单详情页的"联系老师"按钮与陪伴师沟通。如果问题无法解决，请及时联系平台客服，我们会协助处理。',
        expanded: false
      },
      {
        id: 7,
        question: '如何评价陪伴师？',
        answer: '服务完成后，您可以在订单详情页对陪伴师进行评价。真实的评价可以帮助其他家长更好地选择陪伴师，也是对陪伴师工作的认可。',
        expanded: false
      },
      {
        id: 8,
        question: '支付方式有哪些？',
        answer: '目前支持微信支付。支付成功后，款项会暂时托管在平台，服务完成后再结算给陪伴师，保障双方权益。',
        expanded: false
      }
    ],
